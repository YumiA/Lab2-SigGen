...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    vlSelf->sigdelay__DOT__address = ((IData)(vlSelf->rst)
                                       ? 0U : (0xffU 
...
void Vsigdelay___024root___eval(Vsigdelay___024root* vlSelf) {
    ...
    // Body
    if (((IData)(vlSelf->sigdelay__DOT__micRam__DOT__clk) 
         & (~ (IData)(vlSelf->__Vclklast__TOP__sigdelay__DOT__micRam__DOT__clk)))) {
    ...
    // Final
    vlSelf->__Vclklast__TOP__sigdelay__DOT__micRam__DOT__clk 
        = vlSelf->sigdelay__DOT__micRam__DOT__clk;
